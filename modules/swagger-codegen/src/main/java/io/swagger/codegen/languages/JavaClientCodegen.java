                   ...
                   GzipFeatures
{
    ...
    public JavaClientCodegen() {
        ...
        supportedLibraries.put(RETROFIT_2, "HTTP client: OkHttp 3.6.0. JSON processing: Gson 2.7 (Retrofit 2.2.0). Enable the RxJava adapter using '-DuseRxJava[2]=true'. (RxJava 1.x or 2.x)");
